...
export default function SpainMap(){
    ...
    const [showComunityMap, setShowComunityMap] = useState(false);
    const [leftMap, setLeftMap] = useState('madrid');

    const comunityMap = () => {
        setShowComunityMap(false)  
    };

    const cityMap = () => {
        setShowComunityMap(true)  
    };
